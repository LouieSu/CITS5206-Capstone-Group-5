...
# Sample timetable (example for MDS-2024)
student_timetable = [
    ["STAT2402", "CITS1401", "CITS1402", "STAT2401"],       # 24S1
    ["BUSN5003", "CITS5507", "CITS4403", "CITS4404"],       # 24S2
    ["CITS4012", "CITS4009", "STAT4066", "CITS5504"],       # 25S1
    ["CITS5508", "CITS4407", "STAT4064", "CITS5553"]        # 25S2
]
...
if df.empty:
    print("✅ No validation issues found. Timetable satisfies MDS-2024 rules.")
else:
